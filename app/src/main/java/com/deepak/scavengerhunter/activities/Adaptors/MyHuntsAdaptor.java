package com.deepak.scavengerhunter.activities.Adaptors;
...
public class MyHuntsAdaptor extends RecyclerView.Adapter<MyHuntsAdaptor.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        HuntModal huntModal = hunts.get(position);
        holder.tv_huntname.setText(huntModal.getName());
        holder.tv_posts.setText(0);
        ...
        holder.tv_endingPointAddress.setText(huntModal.getEndingArea());
