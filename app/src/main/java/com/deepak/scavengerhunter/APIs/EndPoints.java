...
public class EndPoints {
    ...
    public static final String BASE_URL = "http://172.20.10.4:4000";
    ...
    public static final String GET_LEADERSHIP_HUNTS = BASE_URL + "/hunts/all";
    ...
    public static final String GET_POST_HUNT_DETAILS = BASE_URL + "/hunts/post_details";
}
